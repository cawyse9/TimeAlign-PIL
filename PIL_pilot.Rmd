...
3.	**Complete some questionnaires** about your health, lifestyle and sleep.  Questionnaires will take approximately 10 minutes each to complete and there are 3 in total. 
&nbsp;  
...
1.	There is a small possibility that you might develop skin irritation from the wrist worn strap and we will ask you to be vigilant to this, and to remove the strap immediately and withdraw from the study if signs of irritation are detected.   All the items we use are medical-grade and we do not anticipate skin irritation to be a serious risk.  
